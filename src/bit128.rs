...
///
/// Return `None` if `i > 38`.
pub fn div_single(n: u128, i: usize) -> Option<u128> {
    if i > 38 {
        None
    } else {
...
///
/// It's UB if `i > 38`.
pub unsafe fn unchecked_div_single(n: u128, i: usize) -> u128 {
...
pub fn div_double(n_high: u128, n_low: u128, i: usize) -> Option<(u128, u128)> {
